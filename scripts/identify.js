...
module.exports = function identifyScript(robot) {
  return robot.respond(/identify/i, res => {
    res.send(
      "I am Alfred Thaddeus Crane Pennyworth, mostly known for being the butler of Mr. Wayne aka Batman. Also, I am working for HashLab to help you guys reach your goals."
    );
  });
};
